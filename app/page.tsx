...
export default function Home(){
 ...
 return <main>
  ...
  <section id="contact" className="contact"><div className="wrap"><div className="sectionhead"><span>09</span><h2>Let's Connect</h2></div><div className="contactgrid"><div><h3>Interested in cybersecurity, SOC operations, SIEM, security monitoring, and technology?</h3><p>I'm open to conversations around cybersecurity learning, projects, internships, and technical opportunities.</p><div className="contactlinks"><a href={linkedin} target="_blank"><Icon name="linkedin"/> LinkedIn</a><a href={github} target="_blank"><Icon name="github"/> GitHub</a><a href={`mailto:${email}`}><Icon name="mail"/> Email Me</a></div></div><ContactForm sent={sent} sending={sending} error={error} setSent={setSent} setSending={setSending} setError={setError}/></div></div></section>

  <footer><div className="wrap foot"><div><b>SanketKumar Zanzmera</b><span>Cybersecurity | SOC Analyst | SIEM & Security Monitoring</span></div><div className="footlinks"><a href={linkedin} target="_blank">LinkedIn</a><a href={github} target="_blank">GitHub</a><a href={`mailto:${email}`}>Email</a></div><span>© 2026 SanketKumar Zanzmera. All rights reserved.</span></div></footer>
 </main>
}
